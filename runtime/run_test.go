	...
	table := map[string]struct {
		...
		"fetch-case": {
			...
			options: Options{
				Ci:         false,
				Image:      "inspo-example",
				Source:     inspo.SourceDockerEngine,
				ExportFile: "",
				CiConfig:   nil,
				BuildArgs:  nil,
			},
			events: []testEvent{
				{stdout: "Image Source: docker://inspo-example", stderr: "", errorOnExit: false, errMessage: ""},
